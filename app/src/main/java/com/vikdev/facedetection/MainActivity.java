package com.vikdev.facedetection;
...
public class MainActivity extends AppCompatActivity {
    ...
    private final static int REQUEST_IMAGE_CAPTURE = 177;
    ...
    private void detectFace(Bitmap bitmap) {
        ...
        mDetector.detectInImage(image).addOnSuccessListener(new OnSuccessListener<List<FirebaseVisionFace>>() {
            @Override
